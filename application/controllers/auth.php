...
class Auth extends CI_Controller
{
    ...
    private function _login()
    {
        ...
        if ($user) {
            ...
            $this->session->set_flashdata('password', '<div class="alert alert-danger" role="alert">Email is not registered!</div>');
            redirect('auth');
        }
    }
    ...
    public function registration()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Congrats! Account has been created. Please activate your account</div>');
            redirect('auth');
        }
    }
    ...
    private function _sendEmail($token, $type)
    {
        $config = [
            ...
            'smtp_user' => 'orlandoperdana@gmail.com',
            'smtp_pass' => '***terserah',
            'smtp_port' => 465,
            'mailtype'  => 'html',
            'charset'   => 'utf-8',
        ...
        $this->email->from('orlandoperdana@gmail.com', 'Orlando Perdana Sihombing');
        ...
        if ($type == 'verify') {
            ...
            $this->email->message('Click this link to reset your password : <a href="' . base_url() . 'auth/resetpassword?email=' . $this->input->post('email')
    ...
    public function verify()
    {
        ...
        if ($user) {
            ...
            if ($user_token) {
                ...
                $this->session->set_flashdata('message', '<div class=" alert alert-danger" role= "alert">Account activation failed! Token email</div>');
                redirect('auth');
            }
        } else {
